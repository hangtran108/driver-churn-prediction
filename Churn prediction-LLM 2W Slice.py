...
# Split Train - Test
first_week = driver_data_final['week'].min()
driver_data_final = driver_data_final[driver_data_final['week'] != first_week]
...
driver_data.dtypes
X = driver_data_train[['not_churn', 'sum_sh',
       'completed_trip', 'total_dispatched_request', 'Valid_dispatch',
       ...
       'weekly_amount', 'loyalty_amount']].values
k = []
for i in range (1, 11):
...
def plot_by_woe(df_WoE, rotation_of_x_axis_labels = 0, figsize = (10, 5)):
    ...
    plt.show()
discrete_cols = ['not_churn', 'segment']
